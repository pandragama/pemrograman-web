...
// Jika sesi tambah data sudah dimulai/disimpan
if (isset($_SESSION["start_time"])) {
  // Jika sudah lebih 60 detik semenjak waktu mulai tambah data disimpan 
  if (time() - $_SESSION["start_time"] > 60)  {
    // Hapus bersih isi session dan hancurkan
    session_unset();
    session_destroy();

  } else {
    // Menyimpan waktu mulai sesi tambah data
...
if (isset($_POST["submit"])) {
  ...
  if ($error_message === "") {
    ...
    if ($result) {
      $message = "Data mahasiswa dengan nama = \"<b>$name</b>\" berhasil ditambah";
